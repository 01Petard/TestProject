...
public class FilterBar extends BaseActivity {
    /**
     * 展示城市的数据源
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_bar);
        initDate();
        initView();
    }
    ...
    private void initView() {
        mPlaceAll =  findViewById(R.id.ll_place_tab);
        mPlaceCb =  findViewById(R.id.cb_place);
        mTypeAll =  findViewById(R.id.ll_type);
        mTypeCb =  findViewById(R.id.cb_type);
        mTimeAll =  findViewById(R.id.ll_time);
        mTimeCb =  findViewById(R.id.cb_time);
        // 点击选择城市整体
